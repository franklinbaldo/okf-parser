...
export declare function bytesFromGeometryValue(value: DuckDBValue): Uint8Array;
 ...
 */
export declare function fromVariantValue<T>(value: DuckDBValue, _type: DuckDBType, converter: DuckDBValueConverter<T>): T | null;
