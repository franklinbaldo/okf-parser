...
exports.DuckDBBitVector = void 0;
...
class DuckDBBitVector extends DuckDBVector_1.DuckDBVector {
    dataView;
    validity;
    vector;
    itemOffset;
    ...
    getItem(itemIndex) {
        ...
        const bytes = (0, dataAccessors_1.getStringBytes)(this.dataView, itemIndex * 16);
