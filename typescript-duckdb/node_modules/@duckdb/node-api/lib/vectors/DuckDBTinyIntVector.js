...
exports.DuckDBTinyIntVector = void 0;
...
class DuckDBTinyIntVector extends DuckDBVector_1.DuckDBVector {
    items;
    validity;
    vector;
    ...
    static fromRawVector(vector, itemCount) {
        const data = (0, dataAccessors_1.vectorData)(vector, itemCount * Int8Array.BYTES_PER_ELEMENT);
