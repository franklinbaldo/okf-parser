...
exports.DuckDBSmallIntVector = void 0;
...
class DuckDBSmallIntVector extends DuckDBVector_1.DuckDBVector {
    items;
    validity;
    vector;
    ...
    static fromRawVector(vector, itemCount) {
        const data = (0, dataAccessors_1.vectorData)(vector, itemCount * Int16Array.BYTES_PER_ELEMENT);
