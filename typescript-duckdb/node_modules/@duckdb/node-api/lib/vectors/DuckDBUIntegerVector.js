...
exports.DuckDBUIntegerVector = void 0;
...
class DuckDBUIntegerVector extends DuckDBVector_1.DuckDBVector {
    items;
    validity;
    vector;
    ...
    static fromRawVector(vector, itemCount) {
        const data = (0, dataAccessors_1.vectorData)(vector, itemCount * Uint32Array.BYTES_PER_ELEMENT);
