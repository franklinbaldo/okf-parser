...
exports.DuckDBUTinyIntVector = void 0;
...
class DuckDBUTinyIntVector extends DuckDBVector_1.DuckDBVector {
    items;
    validity;
    vector;
    ...
    static fromRawVector(vector, itemCount) {
        const data = (0, dataAccessors_1.vectorData)(vector, itemCount * Uint8Array.BYTES_PER_ELEMENT);
