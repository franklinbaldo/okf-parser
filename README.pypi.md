...
steps:
  ...
  - uses: franklinbaldo/okf-parser@v0.47.1
    with:
      path: knowledge
```
...
functions as the CLI (see [RFC 0024](https://github.com/franklinbaldo/okf-parser/blob/main/rfcs/0024-rust-native-core.md)).
