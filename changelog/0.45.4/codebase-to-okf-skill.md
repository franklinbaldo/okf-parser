...
- Add compact code-aware lookup by symbol, caller, callee, source and producer-defined type on top of the public generic `load_bundle()` API, without adding code semantics to parser core.
