...
- Regression coverage pins idempotent replay, parsed-value equality despite YAML ordering/quoting, fail-closed unexpected body/null/malformed destinations, atomic mixed batches, CLI exit status and the FastMCP input enum.
